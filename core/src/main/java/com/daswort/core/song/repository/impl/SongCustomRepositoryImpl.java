...
db.song.update(
    ...
    public void updateRef(Author author) {
        ...
        final var update = new Update().set("arrangers.$[a].name", author.getName()).set("composers.$[c].name", author.getName()).set("orchestrators.$[o].name", author.getName()).set("translators.$[t].name", author.getName()).filterArray(Criteria.where("a._id").is(authorId)).filterArray(Criteria.where("c._id").is(authorId)).filterArray(Criteria.where("o._id").is(authorId)).filterArray(Criteria.where("t._id").is(authorId));
    ...
    public void updateRef(Instrument instrument) {
        ...
        final var update = new Update().set("instruments.$[i].title", instrument.getTitle()).filterArray(Criteria.where("i._id").is(instrumentId));
        mongoOperations.update(Song.class).apply(update).all();
    }
    ...
    public void updateRef(Vocal vocals) {
        ...
        final var update = new Update().set("vocals.$[i].title", vocals.getTitle()).filterArray(Criteria.where("i._id").is(vocalId));
        mongoOperations.update(Song.class).apply(update).all();
    }
    ...
    public void updateRef(Topic topic) {
        ...
        final var update = new Update().set("topics.$[i].title", topic.getTitle()).filterArray(Criteria.where("i._id").is(topicId));
        mongoOperations.update(Song.class).apply(update).all();
    }
    ...
    public boolean isReferencedBy(Author author) {
        final var aggregationStages = List.of(new ProjectionOperation().and("composers").concatArrays("arrangers", "orchestrators", "translators").as("authors"), new UnwindOperation(field("authors")), new ReplaceRootOperation(field("authors")), new MatchOperation(where("_id").is(new ObjectId(author.getId()))));
    ...
    public boolean isReferencedBy(Instrument instrument) {
        final var aggregationStages = List.of(new ProjectionOperation(fields("instruments")), new UnwindOperation(field("instruments")), new ReplaceRootOperation(field("instruments")), new MatchOperation(where("_id").is(new ObjectId(instrument.getId()))));
    ...
    public boolean isReferencedBy(Vocal vocal) {
        final var aggregationStages = List.of(new ProjectionOperation(fields("vocals")), new UnwindOperation(field("vocals")), new ReplaceRootOperation(field("vocals")), new MatchOperation(where("_id").is(new ObjectId(vocal.getId()))));
    ...
    public boolean isReferencedBy(Topic topic) {
        final var aggregationStages = List.of(new ProjectionOperation(fields("topics")), new UnwindOperation(field("topics")), new ReplaceRootOperation(field("topics")), new MatchOperation(where("_id").is(new ObjectId(topic.getId()))));
